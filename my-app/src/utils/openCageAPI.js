...
const streetAddress = streetAddress1.split(" ").join("+")

export default {
  //gets location based on user or client based information
  getUserLocation: function() {
    return axios.get("https://api.opencagedata.com/geocode/v1/geojson?q=" + streetAddress + "%2C" + city + "%2C" + state + "%2C" + zip + queryParams)
  }
};